...
- вибір окремого сигналу для детального аналізу;
...
- збереження таблиці піків у файл `results/peaks_table.csv`;
- збереження графіка піків у файл `figures/peaks_plot.png`.
...
Посилання на GitHub-репозиторій буде додано після публікації проєкту.

```text
GitHub: буде додано пізніше
```

## Примітка

У програмі попередньо основним PCG-сигналом використовується `signal_2`, оскільки за результатами візуального перегляду він найбільше відповідає характеру фонокардіографічного сигналу. Остаточне трактування сигналів може уточнюватися відповідно до вихідних даних та вимог керівника роботи.